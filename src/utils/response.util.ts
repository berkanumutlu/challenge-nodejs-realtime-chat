...
export const createPaginatedResponseData = (data: any, totalParam?: number, limit: number = 0, offset: number = 0): PaginatedResponseType => {
    const total: number = totalParam ?? data?.length ?? 0
